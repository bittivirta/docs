...
:::tip Vinkki: voit antaa palvelulle nimen tunnistaaksesi sen laskuissa ja
...
:::warning Muista, minkä ISO-tiedoston valitsit, sillä tarvitset tätä tietoa
myöhemmin! :::
![](https://docs.bittivirta.fi/assets/docs/img/crisp/image_1plmzko.webp)

:::tip ISO-tiedostot päivittyvät, kun tukemme eri käyttöjärjestelmille laajenee.
...
:::tip Jos olet juuri käynnistänyt palvelimen uudelleen, saatat saada
...
:::danger Huomaathan, että jos haluat käyttää työpöytäympäristöä: valitse
