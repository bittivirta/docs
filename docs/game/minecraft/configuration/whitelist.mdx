...
# Pääsylista
Pääsylista (whitelist) on työkalu, jolla voidaan rajoittaa pelaajien liittymistä palvelimelle. Kun whitelist on käytössä, vain erikseen "whitelistatut" pelaajat pääsevät palvelimelle.

Vain OP:t (operaattori/ylläpitäjä) voivat käyttää alla mainittuja komentoja. Voit antaa OP-oikeudet konsolissa pelaajalle komennolla `op [pelaaja]`.

:::danger 
Huomaatan, että pelaajat, joilla on OP voivat antaa OP:n muille pelaajille, vaihtaa pelitilaa ja muuttaa pelin sääntöjä. Anna OP vain pelaajille, joihin todella luotat.
:::
