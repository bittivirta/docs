...
4. Klikkaa "Add schedule" -painiketta
    <Image
        ...
        img={require("./assets/schedule/schedules.png")}
...
<Image
	...
	img={require("./assets/schedule/new-schedule.png")}
	alt="Ajastetut toiminnot"
/>
...
<Image
	img={require("./assets/schedule/schedule-new-task.png")}
...
1. Luo/tallenna toiminto
    <Image
    	img={require("./assets/schedule/schedule-new-task-dialog.png")}
