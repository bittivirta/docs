...
- Ensimmäinen kohta
- Toinen kohta
  (TAB)- Ensimmäinen sisäkkäinen kohta
  (TAB)- Toinen sisäkkäinen kohta
- Kolmas kohta
```
...
Kuvat tuodaan käyttämällä aina `Image` -komponenttia. Kuvan polku annetaan `img` -asetuksen kautta ja sen tulisi olla kuva joka on oikeassa `assets`-kansiossa. Voit myös antaa kuvan maksimileveyden `style` -asetuksen kautta. Kuvan korvaava teksti annetaan `alt` -asetuksen kautta.
...
Koodia varten löydät kokonaan oman sivun: [Koodilohko](code).
