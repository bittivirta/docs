...
Koodia varten löydät kokonaan oman sivun: [Koodi](/docs/formatting/code).

## Pikanäppäimet

Voit ilmaista pikanäppäimiä `<Hotkey />` -komponentilla. Lue lisää: [Pikanäppäimet](/docs/formatting/hotkeys).
...
Löydät ohjeiden askellusta varten kokonaan oman sivun: [Ohjeiden askellus](/docs/formatting/stepper).
