  ...
  return (
    <Layout description="Bittivirta Docs is the help article database for Bittivirta Services.">
      ...
      <main>
          ...
          <CategoryIndex
            ...
            items={[
              ...
              },
              {
                link: "/domain",
                icon: faGlobeStand,
                title: <Translate id="home.pages.domain.title" />,
                description: <Translate id="home.pages.domain.subtitle" />,
              },
              {
                link: "/server/vps",
                icon: faUsbDrive,
        ...
        <div className="container py-20">
          <h2 className="text-3xl">
            <Translate id="home.questions.title" />
          </h2>
          <p className="text-xl">
            <Translate id="home.questions.subtitle" />
          </p>
          <Button to="/company/contact-us" size="lg">
            <FontAwesomeIcon icon={faEnvelope} fixedWidth />{" "}
            <Translate id="home.questions.button" />
          </Button>
        </div>
      </main>
    </Layout>
