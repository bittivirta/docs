...
export default function DocItemPaginator() {
  ...
  const navButtonClasses = 'flex flex-1 items-center justify-between gap-3  md:ms-auto text-start border border-solid border-slate-100 p-3 px-4 rounded-xl bg-white dark:bg-slate-800 dark:border-slate-700 dark:text-cloud shadow-lg text-primary-800 hover:no-underline hover:scale-[1.02] transition-all';
